    ...
    private Image m_Image;
        ...
        void Update()
		{
            ...
            //Vector2 pointerDelta = new Vector2(Input.touches[m_Id].position.x - m_Center.x , Input.touches[m_Id].position.y - m_Center.y).normalized;
              Vector2 pointerDelta = new Vector2((Input.touches[m_Id].position.x - m_Center.x)/Screen.width , (Input.touches[m_Id].position.y - m_Center.y)/Screen.height).normalized;
